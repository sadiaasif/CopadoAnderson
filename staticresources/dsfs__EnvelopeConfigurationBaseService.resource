window.EnvelopeConfigurationBaseService = function (component, helper, successLabel, errorLabel) {
  ...
  function Document(doc) {
    if (doc) {
      ...
      this.LongValue__c = doc[NamespaceLocale.fields["CustomParameterMap__c.LongValue__c"]];
  ...
  Document.prototype.handleDocumentUpload = function (fileUpload) {
    ...
    this.LongValue__c = fileUpload.documentId;
  };
  ...
  function Mapping(map) {
    if (map) {
      ...
      this.LongValue__c = map[NamespaceLocale.fields["CustomParameterMap__c.LongValue__c"]];
  ...
  function Layout(layout) {
    ...
    this.LongValue__c = layout[NamespaceLocale.fields["CustomParameterMap__c.LongValue__c"]];
