({
    doInit: function(component, event, helper) {
        ...
        var actions15 = [
            { label: 'Edit', name: 'edit' },
            { label: 'Delete', name: 'deleteDissolution'}
      ...
      component.set('v.Feedbackcolumns', [
        ...
        component.set('v.Dissolutioncolumns', [
            {label: 'Dissolution Name', fieldName: 'linkName', type: 'url', 
             typeAttributes: {label: { fieldName: 'Name' }, target: '_blank'}},
            { type: 'action', typeAttributes: { rowActions: actions15 }}
        ]);
    ...
    helper.getBookRData(component, helper);
      helper.getassignmentInnData(component, helper);
        ...
        helper.getDissolutionsData(component, helper);
        // Calling feedback
    ...
    handleNextDissolution : function(component, event, helper) { 
        var pageNumber = component.get("v.pageNumberDissolution");
        component.set("v.pageNumberDissolution", pageNumber+1);
        helper.getDissolutionsData(component, helper);
    },
    handlePrevDissolution : function(component, event, helper) {        
        var pageNumber = component.get("v.pageNumberDissolution");
        component.set("v.pageNumberDissolution", pageNumber-1); 
        helper.getDissolutionsData(component, helper);
    },
    ...
    handleRowAction: function (component, event, helper) {
        ...
        switch (action.name) {
            ...
            case 'deleteFeedback':
                ...
                break;
            case 'deleteDissolution':
                helper.deleteDissolutions(component, event, row.Id,helper);
                break;
   ...
   */    $A.util.addClass(cmpTarget, 'slds-show');
    ...
    createDissolutionRecord: function (component, event, helper) {
        var createRecordEvent = $A.get("e.force:createRecord");
        var parentRecordId = component.get("v.recordId");
        createRecordEvent.setParams({
            "entityApiName": "Dissolution__c",
            'defaultFieldValues': {
    ...
    */
    ...
    hideDissolution:function(component,event,helper){
        var elements = document.getElementsByClassName("dissolution-hide");
        elements[0].style.display = 'none';
    },
