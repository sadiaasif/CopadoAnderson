({
    init: function (cmp, event, helper) {
        ...
        if(cmp.get('v.mydata_standard6') && cmp.get('v.mydata_standard6').length > 0){
         ...
         if(cmp.get('v.mydata_standard7') && cmp.get('v.mydata_standard7').length > 0){
            cmp.set('v.mydata', cmp.get('v.mydata_standard7'));
            cmp.set('v.obj', 'standard7');
            cmp.set('v.preSelection', cmp.get('v.selectedRows_standard7'));
        }
...
//        }
    ...
    getSelectedName: function (cmp, event) {
        ...
        if(obj == 'standard1'){
         ...
         else if(obj == 'standard7'){
            cmp.set("v.selectedRows_standard7", selectedRows);   
        }        
